...
```{text code-fold="true" code-summary="生信指导提示词内容（点击展开/收起）"}
...
```{text code-fold="true" code-summary="生信指导提示词内容（无底线版，点击展开/收起）"}
...
如果您发现自己经常需要问某个领域的问题，不妨创建一个**专门的助手**，配合合适的提示词，可以大大提升AI的回答质量。我建议您使用[提示词优化器](https://prompt.always200.com/)这个网站来帮助您设计和优化提示词。
