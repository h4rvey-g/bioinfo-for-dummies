...
5. **渲染为PDF**
   ...
   > `tlmgr install ctex pgf tikz-cd tcolorbox tabularray thmtools ninecolors bropd imakeidx titlesec ulem varwidth adjustbox extarrows anyfontsize appendix enumitem jknapltx psnfss`
