...
5. **渲染为PDF**
   ...
   > `tlmgr install ctex pgf tikz-cd hobby tikzmark tcolorbox tabularray thmtools ninecolors bropd imakeidx titlesec ulem varwidth adjustbox extarrows anyfontsize appendix enumitem jknapltx psnfss`
