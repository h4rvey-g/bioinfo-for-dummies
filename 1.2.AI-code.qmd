...
推荐使用 @sec-env-mgmt 中介绍的Pixi来安装Codex，可以自动同时安装所需的依赖。命令为`pixi global install codex`。

您也可以参考[Codex CLI的官方文档](https://developers.openai.com/codex/cli/#set-up)，按照说明进行安装和配置。注意需要先手动安装Node.js环境。
